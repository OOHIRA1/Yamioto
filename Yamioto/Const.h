...
const int CLEAR = 10;			//ïKóvê≥âêî
const int QUESTION_MAX = 20;	//ç≈ëÂñ‚ëËêî(àÍÇ¬ÇÃñ‚ëËèWÇÃíÜÇÃ)
...
const int RATE_X = SCREEN_WIDTH_CENTER / 150;
const int RATE_Y = SCREEN_HEIGHT_CENTER / 150;
